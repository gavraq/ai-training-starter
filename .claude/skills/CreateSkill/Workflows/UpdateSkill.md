...
Example:
```bash
touch /.claude/skills/WeeklyReview/Workflows/MonthlyRollup.md
```
...
touch /.claude/skills/[SkillName]/scripts/tool_name.py
```
...
Create `/.claude/skills/[SkillName]/Tools/[api-name].md` with:
...
## Step 7: Update Skill Index

Regenerate the skill index to capture changes:
